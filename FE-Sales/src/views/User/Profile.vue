    ...
    <div class="dashboard-admin">
      <div class="container-fluid px-4 py-2">
        ...
        <div class="row">
          ...
          <div class="col-3 " v-for="(item, index) in address" :key="item.id">
            <div class="card px-6 py-2 border-0">
              <div class="row">
                ...
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.nama_penerima" disabled required>
                  <label for="">Nama Penerima</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.nomor_telepon" disabled required>
                  <label for="">Nomor Telpon Penerima</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.jalan" disabled required>
                  <label for="">Jalan</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.kelurahan" disabled required>
                  <label for="">Kelurahan</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.kecamatan" disabled required>
                  <label for="">Kecamatan</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.kota" disabled required>
                  <label for="">Kota</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.provinsi" disabled required>
                  <label for="">Provinsi</label>
                </div>
                <div class="inputbox">
                  <input class="input-type" type="text" v-model="item.kode_pos" disabled required>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" type="text" pattern="[0-9]*" inputmode="numeric"
                        v-model="addAddress.no_telp_penerima" >
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="mb-3">
...
export default {
  ...
  methods: {
    ...
    handleAddress() {
      ...
      axios.post(BASE_URL + '/address/add', formData, axiosConfig)
        .then(response => {
          this.closeModal();
          this.retrieveAddress();
